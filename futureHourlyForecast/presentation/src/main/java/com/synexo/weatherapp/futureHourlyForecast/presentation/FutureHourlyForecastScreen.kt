...
import com.synexo.weatherapp.core.ui.DAY_DATE_MONTH_PATTERN
...
import com.synexo.weatherapp.core.ui.toReadableDate
...
import com.synexo.weatherapp.futureHourlyForecast.presentation.components.HourListItem
import com.synexo.weatherapp.futureHourlyForecast.presentation.components.HumidityVicoLineChart
import com.synexo.weatherapp.futureHourlyForecast.presentation.components.PressureVicoLineChart
import com.synexo.weatherapp.futureHourlyForecast.presentation.components.RainVicoColumnChart
import com.synexo.weatherapp.futureHourlyForecast.presentation.components.TempVicoLineChart
...
private fun GraphHourlyView(
    ...
    Column(
        ...
        TempVicoLineChart(
            ...
            title = stringResource(id = CoreR.string.common_temperature),
            state = state,
        )
        ...
        PressureVicoLineChart(
            modifier = Modifier
                ...
                .fillMaxWidth()
                .padding(horizontal = 10.dp),
            title = stringResource(id = CoreR.string.common_pressure),
            state = state,
        )
        ...
        HumidityVicoLineChart(
            modifier = Modifier
                ...
                .fillMaxWidth()
                .padding(horizontal = 10.dp),
            title = stringResource(id = CoreR.string.common_humidity),
            state = state,
        )
        ...
        RainVicoColumnChart(
            modifier = Modifier
                ...
                .fillMaxWidth()
                .padding(horizontal = 10.dp),
            title = stringResource(id = CoreR.string.common_rain),
            state = state,
        )
    }
}
