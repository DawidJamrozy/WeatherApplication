...
import com.synexo.weatherapp.settings.domain.usecase.ClearAllLocationsUseCase
import com.synexo.weatherapp.settings.domain.usecase.GetAppSettingsUseCase
import com.synexo.weatherapp.settings.domain.usecase.SaveAppSettingsUseCase
